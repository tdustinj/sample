...
use Carbon\Carbon;
class QuoteLaborLine extends Model
{
    //
    protected $table = "quote_labor_lines";
    /**
     ...
     * @var array
     */
    protected $fillable = ['fk_quote_id', 'fk_technician_id', 'fk_products_id', 'sku', 'rate', 'hours', 'description'];
    ...
    public function quote(){
        return $this->belongsTo('App\Models\Quote', 'id');
    }
