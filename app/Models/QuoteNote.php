...
class QuoteNote extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['fk_quote_id','fk_user_id', 'message','fk_note_type','fk_user_id_recipient'];
    ...
    public function note_type(){
        ...
        // $noteType = $this->belongsTo('App\Models\NoteTypes', 'fk_note_type', 'note_type_code');
