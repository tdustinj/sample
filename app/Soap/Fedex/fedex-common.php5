...
function getProperty($var){
  	...
  	// if($var == 'key') Return 'e40kth3RbUVKf3Jp'; 
  	if($var == 'key') Return env('FEDEX_KEY'); 
	// if($var == 'password') Return 'wRnp5bJcAONcQKNLQj6RoSATi'; 
	if($var == 'password') Return env('FEDEX_PASSWORD'); 
	if($var == 'parentkey') Return 'XXX'; 
	if($var == 'parentpassword') Return 'XXX'; 	
	// if($var == 'shipaccount') Return '510087720';
	if($var == 'shipaccount') Return env('FEDEX_SHIPACCOUNT');
	if($var == 'billaccount') Return '510087720';
	if($var == 'dutyaccount') Return 'XXX'; 
	if($var == 'freightaccount') Return 'XXX';  
	if($var == 'trackaccount') Return '117379825';
	...
	if($var == 'meter') Return env('FEDEX_METER');
	// if($var == 'meter') Return '119023931';
		
	if($var == 'shiptimestamp') Return mktime(10, 0, 0, date("m"), date("d")+1, date("Y"));

	if($var == 'spodshipdate') Return '2016-04-13';
	if($var == 'serviceshipdate') Return date("Y-m-d", mktime(8, 0, 0, date("m")  , date("d"), date("Y")));
	...
	if($var == 'trackingnumber') Return '771815877948';
	...
	if($var == 'customerreference') Return '115380173';
...
function setEndpoint($var){
	...
	if($var == 'prod') Return 'https://ws.fedex.com:443/web-services';
	if($var == 'test') Return 'https://wsbeta.fedex.com:443/web-services';
